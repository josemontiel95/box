...
@Component({
  selector: 'app-historico-formato',
  templateUrl: './historico-formato.component.html',
  styleUrls: ['./historico-formato.component.scss','../../loadingArrows.css']
})
export class HistoricoFormatoComponent implements OnInit{
  title = 'app';
  id_Footer: string;
  obra: string;
