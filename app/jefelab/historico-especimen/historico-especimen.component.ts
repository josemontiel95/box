...
@Component({
  selector: 'app-historico-especimen',
  templateUrl: './historico-especimen.component.html',
  styleUrls: ['./historico-especimen.component.scss','../../loadingArrows.css']
})
export class HistoricoEspecimenComponent implements OnInit{
  title = 'app';
  id_Footer: string;
  obra: string;
