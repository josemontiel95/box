...
@Component({
  selector: 'app-dashboardCubo',
  templateUrl: './dashboardCubo.component.html',
  styleUrls: ['./dashboardCubo.component.scss','../../loadingArrows.css']
})
export class dashboardCuboComponent implements OnInit{
