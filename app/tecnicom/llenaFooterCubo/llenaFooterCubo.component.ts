...
@Component({
  selector: 'app-llenaFooterCubo',
  templateUrl: './llenaFooterCubo.component.html',
  styleUrls: ['./llenaFooterCubo.component.scss','../../loadingArrows.css']
})
export class LlenaFooterCuboComponent implements OnInit {
